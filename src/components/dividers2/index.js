  ...
  return (
    <div className={classes.root}>
      <List>
        <ListItem>
          <Avatar>
            <img src={show.meetUPWithData.imgList[0]} style={{width: "100%"}} />
          </Avatar>
          <ListItemText primary={show.meetUPWithData.name}  secondary={new Date(show.time.nanoseconds).toLocaleTimeString() +" - " + new Date(show.time.nanoseconds).toLocaleDateString() + ' / - at ' + show.location.venue.name +"-"+ show.location.venue.location.address} />
...
InsetDividers2.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(InsetDividers2);